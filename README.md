...
I've done some concurrency tests with valgrind to ensure that this package is stable for now, but do beware that this isn't intended to be customizable by the rcl/rclcpp API
